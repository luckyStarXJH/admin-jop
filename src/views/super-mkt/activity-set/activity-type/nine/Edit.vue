  ...
  <div class="Settings">
    <div class="edit-phone-view">
      <div class="view-content">
        ...
        <p style="text-align: center;color: #fff;margin-top: 65px;font-size: 12px;">
        ...
        <div class="game-view">
          <ul class="play">
            <li v-for="(item, index) of giftList" :key="index">
...
.Settings {
  ...
  .edit-phone-view {
    ...
    .view-content {
      width: 100%;
      height: 100%;
      background: url('~@/assets/images/super-crm/mine/jgg.png');
      background-repeat: no-repeat;
      background-size: 100% 100%;
      position: relative;
      width: 83%;
