<template>
  <article class="position-table-wrapper">
    ...
    <!-- 新增会员标签 -->
    <el-dialog title="新增-会员标签"  width="553px" :visible.sync="dialogFormVisible">
      <el-form :model="form">
        <el-form-item label="标签名称：" :label-width="formLabelWidth">
          <el-input placeholder="标签名称最长支持8个汉字" auto-complete="off"></el-input>
        </el-form-item>
        <el-form-item label="标签默认排序：" :label-width="formLabelWidth">
          <el-input placeholder="标签默认排序"></el-input>
        </el-form-item>
        <el-form-item label="标签状态：" :label-width="formLabelWidth">
          <template>
            <el-radio v-model="radioValue" label="1">显示</el-radio>
            <el-radio v-model="radioValue" label="2">隐藏</el-radio>
          </template>
        </el-form-item>
      </el-form>
